...
for char in isikukood:
    ...
    if cnt > 11 or cnt < 11:
        ...
        check1 = ((int(s[0]) * 1) + (int(s[1]) * 2) + (int(s[2]) * 3) + (int(s[3]) * 4) + (int(s[4]) * 5) + (
                    int(s[5]) * 6) + (
                          int(s[6]) * 7) + (int(s[7]) * 8) + (int(s[8]) * 9) + (int(s[9]) * 1))
        check1_1 = int(check1/11)
        check1_2 = check1 - (check1_1*11)
        check2 = ((int(s[0]) * 3) + (int(s[1]) * 4) + (int(s[2]) * 5) + (int(s[3]) * 6) + (int(s[4]) * 7) + (
                int(s[5]) * 8) + (int(s[6]) * 9) + (int(s[7]) * 1) + (int(s[8]) * 2) + (int(s[9]) * 3))
        check2_1 = int(check2 / 11)
        check2_2 = check2 - (check2_1 * 11)
        try:
            ...
            if check1_2 != int(s[10]) and check2_2 != int(s[10]):
